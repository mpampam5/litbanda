...
if (isset($_POST['generate']))
{
    ...
    $mvc  =  safe($_POST['jenis_mvc']);
    if ($mvc =="mvc") {
      $direct_created_view = "views/";
      $direct_created      = "";
      $load_view           = "";
      $direct_url          = "";
    }else {
      $direct_url          ="administrator/";
      $load_view           = "administrator/content/";
      $direct_created      = "modules/administrator/";
      $direct_created_view = "modules/administrator/views/content/";
    }
    ...
    if ($table_name <> '')
    {
        ...
        if (!file_exists($target."".$direct_created_view ."". $c_url))
         {
             mkdir($target."".$direct_created_view ."". $c_url, 0777, true);
         }
