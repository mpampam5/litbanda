...
$string .= "\n\n    public function index()
    {
        ...
        \$config['total_rows'] = \$this->model->total_rows(\$q);
        \$$c_url = \$this->model->get_limit_data(\$config['per_page'], \$start, \$q);
...
$string .="\n\n function index()
    {
      \$this->layouts->set_title('$c_url');
      \$this->layouts->view('cpanel/content/$c_url/$v_list');
    }
...
if ($export_word == '1') {
    $string .= "\n\n    public function word()
    {
        ...
        \$data = array(
            '" . $table_name . "_data' => \$this->model->get_all(),
            'start' => 0
        );
...
$hasil_controller = createFile($string, $target . "modules/cpanel/controllers/" . $c_file);
