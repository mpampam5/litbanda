    ...
    <body>
        <div class="row">
            <div class="col-md-5">
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <?php $jenis_mvc = isset($_POST['jenis_mvc']) ? $_POST['jenis_mvc'] : 'mvc'; ?>
                            <div class="col-md-5">
                                <div class="radio" style="margin-bottom: 0px; margin-top: 0px">
                                    <label>
                                        <input type="radio" name="jenis_mvc" value="mvc" <?php echo $jenis_mvc == 'mvc' ? 'checked' : ''; ?>>
                                        MVC
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="radio" style="margin-bottom: 0px; margin-top: 0px">
                                    <label>
                                        <input type="radio" name="jenis_mvc" value="hmvc" <?php echo $jenis_mvc == 'hmvc' ? 'checked' : ''; ?>>
                                        HMVC
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <label>Title Modul</label>
                        <input type="text" id="title" name="title" value="<?php echo isset($_POST['title']) ? $_POST['title'] : '' ?>" class="form-control" placeholder="Title Name" />
                    </div>
        ...
        <script type="text/javascript">
            ...
            function setname() {
                ...
                if (table_name != '') {
                  document.getElementById('title').value = capitalize(table_name);
