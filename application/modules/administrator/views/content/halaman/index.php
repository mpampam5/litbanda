  ...
  <div class='box-header with-border'>
    <h3 class='box-title'>Modul <?=ucfirst($layout_title)?></h3>
      <div class='box-tools pull-right'>
        <a href='<?=site_url(config_item("cpanel")."halaman/tambah")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
      </div>
  </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url(config_item("cpanel"))?>/halaman/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_halaman",
                            "orderable": false
                        ...
                        {"data": "halaman",
                         render : function(data,type,row,meta){
                                var custom = '<div id="berita">'
                                            +data+'</br>'
                                            +'<a class="url" href="<?=base_url()?>page/'+row.slug+'.html" target="_blank"> page/'+row.slug+'</a></br>'
