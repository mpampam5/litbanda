...
<div class="box">
  ...
  <div class="box-body">
      ...
      <form action="<?=$aksi?>" id="form">
                ...
                <textarea class="form-control" rows="3" name="desc" id="desc" placeholder="Desc"><?php echo $desc; ?></textarea>
            </div>

						 <div class="form-group">
                <label for="enum">Read</label>
...
<hr>
        ...
        <div class="row">
            ...
            <!-- <button type="button" class="btn btn-default btn-sm btn-block" data-dismiss="modal" aria-label="Close">tutup</button> -->
              <a href="<?=site_url(config_item("cpanel").'kontak')?>" class="btn btn-sm btn-default btn-block"> batal</a>
            </div>
              ...
              $('#pesan').append('<div class="alert alert-success">'+
                ...
                $('.alert-success').delay(500).show(10, function(){
                  $('.alert-success').delay(5000).hide(10, function(){
                    ...
                    window.location.href="<?=site_url(config_item("cpanel").'kontak')?>";
                  });
                })
            }else {
