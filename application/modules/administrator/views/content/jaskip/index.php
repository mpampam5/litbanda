  ...
  <div class='box-header with-border'>
    <h3 class='box-title'>Modul <?=ucfirst($layout_title)?></h3>
      <div class='box-tools pull-right'>
        <a href='<?=site_url("administrator/jaskip/tambah")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
      </div>
  </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url()?>administrator/jaskip/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_jaskip",
                            "orderable": false,
                        ...
                        {
                          return '<h5 style="text-transform: uppercase!important;">'+data+'</h5>'
                                  +'<a href="<?=base_url()?>file/uploads/pdf/'+row.file+'" class="btn btn-info btn-xs" target="_blank"><i class="fa fa-file"></i> Lihat File</a>&nbsp;'+row.action;
                        }
                        },
                        {"data": "file",
                          "visible":false
